...
typedef enum
{
    UANativeAdOrientationAny,
    UANativeAdOrientationPortrait,
    UANativeAdOrientationLandscape
} UANativeAdOrientation;

@protocol UAAdViewDelegate;

/**
 * The UAAdView class provides a view that can display banner advertisements.
 */

@interface UAAdView : UIView

/** @name Initializing a Banner Ad */

/**
 * Initializes an UAAdView with the given ad unit ID and banner size.
 *
 * @param adUnitId A string representing a MoPub ad unit ID.
 * @param size The desired ad size. A list of standard ad sizes is available in UAConstants.h.
...
/**
 * The delegate (`UAAdViewDelegate`) of the ad view.
 *
 * @warning **Important**: Before releasing an instance of `UAAdView`, you must set its delegate
 * property to `nil`.
 */
@property (nonatomic, weak) id<UAAdViewDelegate> delegate;
 ...
 * if you call this with UAInterfaceOrientationPortrait, native networks (e.g. iAd) will never
 * return ads sized for the landscape orientation.
 *
 * @param orientation An UANativeAdOrientation enum value.
 *
...
- (void)lockNativeAdsToOrientation:(UANativeAdOrientation)orientation;
 ...
 * events using a subclass of `UABannerCustomEvent`.
 */
...
/**
 * Replaces the content of the UAAdView with the specified view.
 *
 * @bug **Warning**: This method has been deprecated. You should instead implement banner custom
 * events using a subclass of `UABannerCustomEvent`.
 *
...
/**
 * The delegate of an `UAAdView` object must adopt the `UAAdViewDelegate` protocol. It must
...
@protocol UAAdViewDelegate <NSObject>
 ...
 */
- (void)adViewDidLoadAd:(UAAdView *)view;
 ...
 * @param view The ad view sending the message.
 */
- (void)adViewDidFailToLoadAd:(UAAdView *)view;
 ...
 */
- (void)willPresentModalViewForAd:(UAAdView *)view;
 ...
 */
- (void)didDismissModalViewForAd:(UAAdView *)view;
 ...
 * @param view The ad view sending the message.
 */
- (void)willLeaveApplicationFromAd:(UAAdView *)view;

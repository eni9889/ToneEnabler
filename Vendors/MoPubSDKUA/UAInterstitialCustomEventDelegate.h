//
//  UAInterstitialCustomEventDelegate.h
//  MoPub
//
...
/**
 * Instances of your custom subclass of `UAInterstitialCustomEvent` will have an `UAInterstitialCustomEventDelegate` delegate.
 ...
 * network's events and the callbacks defined on `UAInterstitialCustomEventDelegate`.
 */

@protocol UAInterstitialCustomEventDelegate <NSObject>

/**
 * The user's current location.
 *
 * @return This method provides the location that was passed into the parent `UAInterstitialAdController`.  The MoPub
 * SDK does **not** automatically request the user's location.  It is your responsibility to pass the location
 * into `UAInterstitialAdController`.
 *
 ...
 *
 * @warning **Important**: You should **only** call this method if you have [opted out of automatic click and impression tracking]([UAInterstitialCustomEvent enableAutomaticImpressionAndClickTracking]).

...
/**
 * The `UACollectionViewAdPlacer` class allows you to request native ads from the MoPub ad server
...
@interface UACollectionViewAdPlacer : NSObject
 ...
 * `UAServerAdPositioning` object as the `positioning` parameter.
 *
 ...
 * implement the `UANativeAdRendering` protocol and must be a subclass of `UICollectionViewCell`.
 *
 * @return An `UACollectionViewAdPlacer` object.
 */
 ...
 *
 * First, you may pass an `UAServerAdPositioning` object as the `positioning` parameter, which tells
 ...
 * this as well.
 *
 * Alternatively, if you wish to hard-code your positions, you may pass an `UAClientAdPositioning`
 * object instead.
 *
 * @param collectionView The collection view in which to insert ads.
 * @param controller The view controller which should be used to present modal content.
 ...
 * responsibilities related to `UACollectionViewAdPlacer`. These APIs include methods to help notify
...
@interface UICollectionView (UACollectionViewAdPlacer)

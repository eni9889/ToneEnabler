...
/**
 * The `UANativeAdRequestTargeting` class is used to attach targeting information to
 * `UANativeAdRequest` objects.
 */

@interface UANativeAdRequestTargeting : NSObject

/** @name Creating a Targeting Object */

/**
 * Creates and returns an empty UANativeAdRequestTargeting object.
 *
 * @return A newly initialized UANativeAdRequestTargeting object.
 */

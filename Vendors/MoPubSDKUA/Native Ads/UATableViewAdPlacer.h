...
/**
 * The `UATableViewAdPlacer` class allows you to request native ads from the MoPub ad server and
...
@interface UATableViewAdPlacer : NSObject
 ...
 * implement the `UANativeAdRendering` protocol and must be a subclass of `UITableViewCell`.
 *
 * @return An `UATableViewAdPlacer` object.
 */
 ...
 * responsibilities related to `UATableViewAdPlacer`. These APIs include methods to help notify the
...
@interface UITableView (UATableViewAdPlacer)

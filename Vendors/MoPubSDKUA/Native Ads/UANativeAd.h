...
@protocol UANativeAdDelegate;
@class UAAdConfiguration;

/**
 * The `UANativeAd` class is used to render and manage events for a native advertisement. The
...
@interface UANativeAd : NSObject

/** @name Ad Resources */

/**
 * The delegate of the `UANativeAd` object.
 */
@property (nonatomic, weak) id<UANativeAdDelegate> delegate;
 ...
 *
 * The provided view should implement the `UANativeAdRendering` protocol to correctly display the ad
 * content.
 *
 ...
 * method requires the UANativeAd to have an UANativeAdDelegate that implements viewControllerForPresentingModalView.
 */

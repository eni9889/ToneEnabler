...
/**
 * The UATableViewAdManager class provides convenient functionality for adding advertisements
 ...
 *
 * **Warning**: This class has been deprecated. Use the `UATableViewAdPlacer` class instead to
 * display ads within a table view.
 */

@interface UATableViewAdManager : NSObject
 ...
 * should implement the UANativeAdRendering protocol.
 * @see UANativeAdRendering
 */
- (UITableViewCell *)adCellForAd:(UANativeAd *)adObject cellClass:(Class)cellClass __attribute__((deprecated));

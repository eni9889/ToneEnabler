...
@interface UAAdPlacerInvocation : NSObject
 ...
 * @param streamAdPlacer The UAStreamAdPlacer backing your UI collection that can translate index paths to their originals.
 *
...
+ (NSInvocation *)invokeForTarget:(id)target
                 with2ArgSelector:(SEL)selector
                   ...
                   streamAdPlacer:(UAStreamAdPlacer *)streamAdPlacer;

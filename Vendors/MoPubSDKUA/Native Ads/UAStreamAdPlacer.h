...
@protocol UAStreamAdPlacerDelegate;
@protocol UANativeAdRendering;
@class UANativeAdRequestTargeting;

/**
 * The `UAStreamAdPlacer` class allows you to retrieve native ads from the MoPub ad server and
 ...
 * `UAStreamAdPlacerDelegate` protocol to handle ad insertions.
 *
...
@interface UAStreamAdPlacer : NSObject
...
@property (nonatomic, weak) id<UAStreamAdPlacerDelegate> delegate;
@property (nonatomic, readonly, copy) UAAdPositioning *adPositioning;
 ...
 * of `UIView` and also needs to implement the `UANativeAdRendering` protocol.
 */
...
@protocol UAStreamAdPlacerDelegate <NSObject>

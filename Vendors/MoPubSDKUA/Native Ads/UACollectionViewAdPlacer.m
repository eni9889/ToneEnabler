//
//  UACollectionViewAdPlacer.m
//  MoPub
//
//  Copyright (c) 2014 MoPub. All rights reserved.
//

#import "UACollectionViewAdPlacer.h"
...
@interface UACollectionViewAdPlacer () <UICollectionViewDataSource, UICollectionViewDelegate, UAStreamAdPlacerDelegate, UICollectionViewDelegateFlowLayout>
...
@implementation UACollectionViewAdPlacer
...
{
    return [[self class] placerWithCollectionView:collectionView viewController:controller adPositioning:[UAServerAdPositioning positioning] defaultAdRenderingClass:defaultAdRenderingClass];
}

+ (instancetype)placerWithCollectionView:(UICollectionView *)collectionView viewController:(UIViewController *)controller adPositioning:(UAAdPositioning *)positioning defaultAdRenderingClass:(Class)defaultAdRenderingClass
{
    UACollectionViewAdPlacer *collectionViewAdPlacer = [[UACollectionViewAdPlacer alloc] initWithCollectionView:collectionView viewController:controller adPositioning:positioning defaultAdRenderingClass:defaultAdRenderingClass];
    return collectionViewAdPlacer;
}

- (instancetype)initWithCollectionView:(UICollectionView *)collectionView viewController:(UIViewController *)controller adPositioning:(UAAdPositioning *)positioning defaultAdRenderingClass:(Class)defaultAdRenderingClass
{
    ...
    if (self = [super init]) {
        ...
        _insertionTimer = [UATimer timerWithTimeInterval:kUpdateVisibleCellsInterval target:self selector:@selector(updateVisibleCells) repeats:YES];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    if ([self.streamAdPlacer isAdAtIndexPath:indexPath]) {
        ...
        UICollectionViewCell<UANativeAdRendering> *cell = (UICollectionViewCell<UANativeAdRendering> *)[collectionView dequeueReusableCellWithReuseIdentifier:identifier forIndexPath:indexPath];
...
{
    [UAAdPlacerInvocation invokeForTarget:self.originalDelegate with2ArgSelector:@selector(collectionView:didDeselectItemAtIndexPath:) firstArg:collectionView secondArg:indexPath streamAdPlacer:self.streamAdPlacer];
}

- (void)collectionView:(UICollectionView *)collectionView didEndDisplayingCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath
{
    [UAAdPlacerInvocation invokeForTarget:self.originalDelegate with3ArgSelector:@selector(collectionView:didEndDisplayingCell:forItemAtIndexPath:) firstArg:collectionView secondArg:cell thirdArg:indexPath streamAdPlacer:self.streamAdPlacer];
}

- (void)collectionView:(UICollectionView *)collectionView didHighlightItemAtIndexPath:(NSIndexPath *)indexPath
{
    [UAAdPlacerInvocation invokeForTarget:self.originalDelegate with2ArgSelector:@selector(collectionView:didHighlightItemAtIndexPath:) firstArg:collectionView secondArg:indexPath streamAdPlacer:self.streamAdPlacer];
}
...
{
    [UAAdPlacerInvocation invokeForTarget:self.originalDelegate with2ArgSelector:@selector(collectionView:didUnhighlightItemAtIndexPath:) firstArg:collectionView secondArg:indexPath streamAdPlacer:self.streamAdPlacer];
}
...
{
    NSInvocation *invocation = [UAAdPlacerInvocation invokeForTarget:self.originalDelegate with2ArgSelector:@selector(collectionView:shouldDeselectItemAtIndexPath:) firstArg:collectionView secondArg:indexPath streamAdPlacer:self.streamAdPlacer];
...
{
    NSInvocation *invocation = [UAAdPlacerInvocation invokeForTarget:self.originalDelegate with2ArgSelector:@selector(collectionView:shouldHighlightItemAtIndexPath:) firstArg:collectionView secondArg:indexPath streamAdPlacer:self.streamAdPlacer];
...
{
    NSInvocation *invocation = [UAAdPlacerInvocation invokeForTarget:self.originalDelegate with2ArgSelector:@selector(collectionView:shouldSelectItemAtIndexPath:) firstArg:collectionView secondArg:indexPath streamAdPlacer:self.streamAdPlacer];

    return [UAAdPlacerInvocation boolResultForInvocation:invocation defaultValue:collectionView.allowsSelection];
}

- (BOOL)collectionView:(UICollectionView *)collectionView shouldShowMenuForItemAtIndexPath:(NSIndexPath *)indexPath
{
    NSInvocation *invocation = [UAAdPlacerInvocation invokeForTarget:self.originalDelegate with2ArgSelector:@selector(collectionView:shouldShowMenuForItemAtIndexPath:) firstArg:collectionView secondArg:indexPath streamAdPlacer:self.streamAdPlacer];
...
@implementation UICollectionView (UACollectionViewAdPlacer)

static char kAdPlacerKey;

- (void)mp_setAdPlacer:(UACollectionViewAdPlacer *)placer
{
    objc_setAssociatedObject(self, &kAdPlacerKey, placer, OBJC_ASSOCIATION_ASSIGN);
}

- (UACollectionViewAdPlacer *)mp_adPlacer
{
...
{
    UACollectionViewAdPlacer *adPlacer = [self mp_adPlacer];

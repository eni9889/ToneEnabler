...
/**
 * The UANativeAdRendering protocol provides methods for displaying ad content in
 * custom view classes.
 */

@protocol UANativeAdRendering <NSObject>
 ...
 * @see [UANativeAd loadTextIntoLabel:]
 * @see [UANativeAd loadTitleIntoLabel:]
 * @see [UANativeAd loadIconIntoImageView:]
 * @see [UANativeAd loadImageIntoImageView:]
 * @see [UANativeAd loadCallToActionTextIntoLabel:]
 * @see [UANativeAd loadCallToActionTextIntoButton:]
 * @see [UANativeAd loadImageForURL:intoImageView:]
 */
- (void)layoutAdAssets:(UANativeAd *)adObject;

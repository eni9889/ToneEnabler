...
/**
 * The `UAClientAdPositioning` class is a model that allows you to control the positions where
 ...
 *
 * Unlike with `UAServerAdPositioning`, which tells an ad placer to obtain its positioning
...
@interface UAClientAdPositioning : UAAdPositioning

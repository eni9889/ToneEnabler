//
//  UAMRAIDInterstitialViewController.m
//  MoPub
//
...
@interface UAMRAIDInterstitialViewController ()
...
@implementation UAMRAIDInterstitialViewController
...
- (id)initWithAdConfiguration:(UAAdConfiguration *)configuration
{
    ...
    if (self) {
        ...
        self.interstitialView = [[UAInstanceProvider sharedProvider] buildMRAdViewWithFrame:frame
                                                                            allowsExpansion:NO

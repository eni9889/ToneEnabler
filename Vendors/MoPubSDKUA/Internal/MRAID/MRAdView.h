...
@class MRAdViewDisplayController, MRProperty, UAAdConfiguration;
...
@interface MRAdView : UIView <UIWebViewDelegate, UAAdDestinationDisplayAgentDelegate, MRCalendarManagerDelegate, MRPictureManagerDelegate, MRVideoPlayerManagerDelegate> {

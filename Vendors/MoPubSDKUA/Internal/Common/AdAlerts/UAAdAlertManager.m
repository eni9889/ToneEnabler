...
#import "UAAdAlertManager.h"
#import "UAAdConfiguration.h"
#import "UAAdAlertGestureRecognizer.h"
#import "UALogging.h"
...
@interface UAAdAlertManager () <UIGestureRecognizerDelegate, MFMailComposeViewControllerDelegate>

@property (nonatomic, assign) BOOL processedAlert;
@property (nonatomic, strong) UAAdAlertGestureRecognizer *adAlertGestureRecognizer;
@property (nonatomic, strong) MFMailComposeViewController *currentOpenMailVC;

@end

@implementation UAAdAlertManager
...
- (id)init
{
    ...
    if(self != nil)
    {
        self.adAlertGestureRecognizer = [[UACoreInstanceProvider sharedProvider] buildUAAdAlertGestureRecognizerWithTarget:self
...
- (void)dealloc
{
    ...
    self.currentOpenMailVC.mailComposeDelegate = [UALastResortDelegate sharedDelegate];
...
- (void)processAdAlert
{
    ...
    UALogInfo(@"UAAdAlertManager processing ad alert");
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^
    {
        ...
        dispatch_async(dispatch_get_main_queue(), ^
        {
            ...
            [params setValue:[UAIdentityProvider identifier] forKey:@"device_id"];
            ...
            [params setValue:UA_SDK_VERSION forKey:@"sdk_version"];
            ...
            UALogInfo(@"UAAdAlertManager finished processing ad alert");
        });
    });
}
...
{
    UALogInfo(@"UAAdAlertManager alert gesture recognized");
...
- (void)processAdParams:(NSDictionary *)params andScreenshot:(UIImage *)screenshot
{
    ...
    [[self.delegate viewControllerForPresentingMailVC] mp_presentModalViewController:self.currentOpenMailVC animated:UA_ANIMATED];
...
- (void)mailComposeController:(MFMailComposeViewController*)controller didFinishWithResult:(MFMailComposeResult)result error:(NSError*)error
{
    ...
    [[self.delegate viewControllerForPresentingMailVC] mp_dismissModalViewControllerAnimated:UA_ANIMATED];
}

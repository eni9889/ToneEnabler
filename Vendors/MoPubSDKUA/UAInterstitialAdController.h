...
@protocol UAInterstitialAdControllerDelegate;

/**
 * The `UAInterstitialAdController` class provides a full-screen advertisement that can be
 * displayed during natural transition points in your application.
 */

@interface UAInterstitialAdController : UIViewController
...
/**
 * The delegate (`UAInterstitialAdControllerDelegate`) of the interstitial ad object.
 */
@property (nonatomic, weak) id<UAInterstitialAdControllerDelegate> delegate;
 ...
 * `UAInterstitialAdControllerDelegate` if you would like to be notified as loading succeeds or
 * fails.
 */
- (void)loadAd;
 ...
 * third-party ad networks. See `UAInterstitialAdControllerDelegate` for more details.
 */
 ...
 *
 * `UAInterstitialAdControllerDelegate` provides optional methods that you may implement to stay
 ...
 * custom events using a subclass of `UAInterstitialCustomEvent`.
 */
...
/**
 * The delegate of an `UAInterstitialAdController` object must adopt the
 * `UAInterstitialAdControllerDelegate` protocol.
 *
...
@protocol UAInterstitialAdControllerDelegate <NSObject>
 ...
 */
- (void)interstitialDidLoadAd:(UAInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidFailToLoadAd:(UAInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialWillAppear:(UAInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidAppear:(UAInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialWillDisappear:(UAInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidDisappear:(UAInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidExpire:(UAInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidReceiveTapEvent:(UAInterstitialAdController *)interstitial;
 ...
 */
- (void)dismissInterstitial:(UAInterstitialAdController *)interstitial __attribute__((deprecated));

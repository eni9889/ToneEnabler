...
/**
 * The `UAAdConversionTracker` class provides a mechanism for reporting application download
...
@interface UAAdConversionTracker : NSObject <NSURLConnectionDataDelegate>
#else
@interface UAAdConversionTracker : NSObject
#endif

/** @name Recording Conversions */

/**
 * Returns the shared instance of the `UAAdConversionTracker` class.
 *
 * @return A singleton `UAAdConversionTracker` object.
 */

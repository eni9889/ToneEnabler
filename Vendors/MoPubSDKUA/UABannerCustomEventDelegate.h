...
/**
 * Instances of your custom subclass of `UABannerCustomEvent` will have an `UABannerCustomEventDelegate` delegate.
 ...
 * network's events and the callbacks defined on `UABannerCustomEventDelegate`.
 */

@protocol UABannerCustomEventDelegate <NSObject>

/**
 * The view controller instance to use when presenting modals.
 *
 * @return `viewControllerForPresentingModalView` returns theUA same view controller that you
 * specify when implementing the `UAAdViewDelegate` protocol.
 */
 ...
 *
 * @return This method provides the location that was passed into the parent `UAAdView`.  The MoPub
 ...
 *
 * @param ad The `UIView` representing the banner ad.  This view will be inserted into the `UAAdView`
 ...
 *
 * @warning **Important**: You should **only** call this method if you have [opted out of automatic click and impression tracking]([UABannerCustomEvent enableAutomaticImpressionAndClickTracking]).
